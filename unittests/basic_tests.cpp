...
TEST_CASE("std::vector") {
    ...
    CHECK(hash_fcn(int_data1.data(), int_data1.size()) == 0); // Use std::hash
    CHECK(hash_fcn(int_data2.data(), int_data2.size()) == 0); // Use clhash::CLHash
    CHECK(hash_fcn(int_data2.data(), int_data2.size()) == hash_fcn(int_data2)); // Use clhash::CLHash
}
